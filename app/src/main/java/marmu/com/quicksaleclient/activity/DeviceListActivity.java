...
public class DeviceListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPairedDevicesArrayAdapter = new ArrayAdapter<>(this, R.layout.list_layout_bluetooth_device);
        mNewDevicesArrayAdapter = new ArrayAdapter<>(this, R.layout.list_layout_bluetooth_device);
